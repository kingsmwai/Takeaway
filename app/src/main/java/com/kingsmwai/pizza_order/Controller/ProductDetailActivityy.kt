...
import kotlinx.android.synthetic.main.activity_product_detail_activityy.*

class ProductDetailActivityy : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_product_detail_activityy)
    ...
    private fun loadDetailProduct(productId: String) {
        val valueEventListener = object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                Picasso.get()
                    .load(product.image)
                    .placeholder(com.google.firebase.database.R.drawable.notification_bg_low_normal)
                    .error(com.google.firebase.database.R.drawable.notification_bg)
                    .into(product_img)
