...
import kotlinx.android.synthetic.main.activity_sign_up_activityy.*

class SignUpActivityy : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sign_up_activityy)
            ...
            val valueEventListener = object : ValueEventListener {
                ...
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    if (dataSnapshot.child(et_signUp_phone_number.text.toString()).exists()) {
                        "This phone number already registered.".toast(this@SignUpActivityy)
                    } else {
                        ...
                        "User registered successful.".toast(this@SignUpActivityy)
                        finish()
                    }
                }
            }
    ...
    fun intentSignIn(view: View) {
        startActivity(Intent(this, SignInActivityy::class.java))
    }
